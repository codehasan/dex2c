...
One Step Installation: Run Below Command
   ```bash
   PKG install wget && wget -O termux_install.sh https://raw.githubusercontent.com/codehasan/dex2c/termux_install.sh && chmod +x termux_install.sh && ./termux_install.sh
   ```
